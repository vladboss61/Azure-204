...
namespace Exercise_1_Code_KV;

internal sealed class Program
{
    public static async Task Main(string[] args)
    {
        string keyVaultName = "vladv-kv100";
    ...
    public static async Task CreateSecretAsync(SecretClient client)
    {
        try
        {
            Console.Clear();
    ...
    public static async Task ListSecretsAsync(SecretClient client)
    {
        try
        {
            Console.Clear();
